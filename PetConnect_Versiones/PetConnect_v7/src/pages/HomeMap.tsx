              ...
              <Popup>
                <div style={{ minWidth: '200px' }}>
                  ...
                  <button
                    ...
                    style={{
                      marginTop: '6px', padding: '6px 14px', background: '#4682ca', color: 'white',
                      border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '12px', width: '100%',
                    }}
                  >
                    Ver detalles
                  </button>
              ...
              <Popup>
                <div style={{ minWidth: '200px' }}>
                  ...
                  <button
                    onClick={() => setSelectedClinic(c)}
                    style={{
                      marginTop: '6px', padding: '6px 14px', background: '#dc2626', color: 'white',
                      border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '12px', width: '100%',
                    }}
                  >
                    Ver detalles
