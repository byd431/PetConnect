...
import { Map, LogOut, User, ShoppingBag, MessageSquare, Crown, Stethoscope, Bell, Shield, Moon, Sun, Smartphone } from 'lucide-react';
...
export const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans">
      <nav className="bg-primary text-white p-4 shadow-md z-[500] transition-colors">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
          ...
          <div className="flex items-center flex-wrap justify-center gap-4 text-sm">
            ...
            >
              {theme === 'dark' ? <Sun size={16} className="text-yellow-300" /> : <Moon size={16} />}
            </button>
            ...
            {deferredPrompt && (
              <button 
                ...
                className="flex items-center gap-1 bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-3 rounded-full animate-pulse transition-colors"
