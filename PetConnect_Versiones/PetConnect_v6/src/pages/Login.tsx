...
export const Login = () => {
  ...
  const handleMockLogin = (plan: 'FREE' | 'PREMIUM') => {
    loginMock(plan);
    navigate('/');
  };
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        ...
        <div className="flex gap-2">
          <button
            ...
            id="btn-mock-premium"
            className="flex-1 bg-[#f29933] hover:bg-orange-500 text-white font-bold py-2 rounded-md text-sm transition-colors"
          >
            ⭐ Premium
          </button>
          <button
            onClick={() => handleMockLogin('FREE')}
            id="btn-mock-free"
            className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 rounded-md text-sm transition-colors"
          >
            Gratis
          </button>
        </div>
